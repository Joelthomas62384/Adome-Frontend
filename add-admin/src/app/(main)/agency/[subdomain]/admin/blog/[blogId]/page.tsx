...
const Page = ({params} : Props) => {
  ...
  const saveBlog = async () => {
    try{
      const response = await axiosInstance.put(`blog/${schemaName}/blog/${blogId}`, {content: data, title, published});
  ...
  return (
    <div className="w-full h-screen overflow-y-auto flex flex-col items-center px-6">
